        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5">
                <div class="about-content">
                    ...
                    <a href="about.html" class="default-btn border-radius-5">Read More <i class="flaticon-right-arrow"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-4 col-6">
                <div class="team-item">
                    ...
                    <div class="team-vector">
                        <img src="assets/images/team/team-vector.png" alt="Vector" />
                    </div>
                </div>
            </div>
...
<div class="training-area pb-100">
    <div class="container">
        <div class="training-content">
            ...
            <a href="about.html" class="default-btn border-radius-5">Get Started <i class="flaticon-right-arrow"></i></a>
        </div>
    </div>
</div>
<!-- Training Area End -->
